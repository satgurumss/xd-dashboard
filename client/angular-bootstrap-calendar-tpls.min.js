...
! function(e, t) {
	...
	return function(e) {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlCalendarCtrl", ["$scope", "$log", "$timeout", "$attrs", "$locale", "moment", "calendarTitle", "calendarHelper",
				function(e, t, n, r, i, l, d, s) {
					function o(e) {
					...
					function c() {
						d[v.view] && a.isDefined(r.viewTitle) && (v.viewTitle = d[v.view](v.viewDate)), v.events = v.events.filter(o).map(function(e, t) {
					...
					s.loadTemplates().then(function() {
						v.templatesLoaded = !0;
						var t = !1;
						e.$watchGroup(["vm.viewDate", "vm.view", "vm.cellIsOpen",
							function() {
			...
			]).directive("mwlCalendar", ["calendarConfig",
				function(e) {
					return {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlCalendarDayCtrl", ["$scope", "$sce", "moment", "calendarHelper",
				function(e, t, n, a) {
					var r = this;
					r.$sce = t, e.$on("calendar.refreshView", function() {
						r.dayViewSplit = r.dayViewSplit || 30, r.dayViewHeight = a.getDayViewHeight(r.dayViewStart, r.dayViewEnd, r.dayViewSplit), r.view = a.getDayView(r.events, r.viewDate, r.dayViewStart, r.dayViewEnd, r.dayViewSplit)
					}), r.eventDragComplete = function(e, t) {
						var a = t * r.dayViewSplit,
							i = n(e.startsAt).add(a, "minutes"),
							l = n(e.endsAt).add(a, "minutes");
						delete e.tempStartsAt, r.onEventTimesChanged({
							calendarEvent: e,
							calendarNewEventStart: i.toDate(),
							calendarNewEventEnd: e.endsAt ? l.toDate() : null
						})
					}, r.eventDragged = function(e, t) {
						var a = t * r.dayViewSplit;
						e.tempStartsAt = n(e.startsAt).add(a, "minutes").toDate()
					}, r.eventResizeComplete = function(e, t, a) {
						var i = a * r.dayViewSplit,
							l = n(e.startsAt),
							d = n(e.endsAt);
						"start" === t ? l.add(i, "minutes") : d.add(i, "minutes"), delete e.tempStartsAt, r.onEventTimesChanged({
							calendarEvent: e,
							calendarNewEventStart: l.toDate(),
							calendarNewEventEnd: d.toDate()
						})
					}, r.eventResized = function(e, t, a) {
						var i = a * r.dayViewSplit;
						"start" === t && (e.tempStartsAt = n(e.startsAt).add(i, "minutes").toDate())
					}
				}
			]).directive("mwlCalendarDay", ["calendarConfig",
				function(e) {
					return {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlCalendarHourListCtrl", ["$scope", "$attrs", "moment", "calendarConfig", "calendarHelper",
				function(e, t, n, a, r) {
					function i() {
						l = n(s.dayViewStart || "00:00", "HH:mm"), d = n(s.dayViewEnd || "23:00", "HH:mm"), s.dayViewSplit = parseInt(s.dayViewSplit), s.hours = [];
						var e = n(s.viewDate).clone();
						t.dayWidth && (e = e.startOf("week")), e.hours(l.hours()).minutes(l.minutes()).seconds(l.seconds());
						for (var i = 0; i <= d.diff(l, "hours"); i++) s.hours.push({
							label: r.formatDate(e, a.dateFormats.hour),
							date: e.clone()
						}), e.add(1, "hour");
						s.hourChunks = [];
						for (var o = 0; o < 60 / s.dayViewSplit; o++) s.hourChunks.push(o)
					}
					var l, d, s = this,
						o = n.locale();
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlCalendarMonthCtrl", ["$scope", "moment", "calendarHelper", "calendarConfig",
				function(e, t, n, a) {
					var r = this;
					r.calendarConfig = a, r.openRowIndex = null, e.$on("calendar.refreshView", function() {
						r.weekDays = n.getWeekDayNames(), r.view = n.getMonthView(r.events, r.viewDate, r.cellModifier);
						...
						r.cellIsOpen && null === r.openRowIndex && (r.openDayIndex = null, r.view.forEach(function(e) {
							e.inMonth && t(r.viewDate).startOf("day").isSame(e.date) && r.dayClicked(e, !0)
						}))
			...
			]).directive("mwlCalendarMonth", ["calendarConfig",
				function(e) {
					return {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlCalendarSlideBoxCtrl", ["$sce", "$scope", "$timeout", "calendarConfig",
				function(e, t, n, a) {
					var r = this;
			...
			]).directive("mwlCalendarSlideBox", ["calendarConfig",
				function(e) {
					return {
						restrict: "E",
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlCalendarWeekCtrl", ["$scope", "$sce", "moment", "calendarHelper", "calendarConfig",
				function(e, t, n, a, r) {
					var i = this;
					...
					}, i.eventDropped = function(e, t) {
						var a = n(t).diff(n(e.startsAt), "days");
						i.weekDragged(e, a)
			...
			]).directive("mwlCalendarWeek", ["calendarConfig",
				function(e) {
					return {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlCalendarYearCtrl", ["$scope", "moment", "calendarHelper",
				function(e, t, n) {
					var a = this;
					a.openMonthIndex = null, e.$on("calendar.refreshView", function() {
						...
						if (t || (a.onTimespanClick({
							...
							r === a.openMonthIndex ? (a.openMonthIndex = null, a.cellIsOpen = !1) : (a.openMonthIndex = r, a.openRowIndex = Math.floor(r / 4), a.cellIsOpen = !0)
						}
			...
			]).directive("mwlCalendarYear", ["calendarConfig",
				function(e) {
					return {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlCollapseFallbackCtrl", ["$scope", "$attrs", "$element",
				function(e, t, n) {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlDateModifierCtrl", ["$element", "$attrs", "$scope", "moment",
				function(e, t, n, r) {
					function i() {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlDraggableCtrl", ["$element", "$scope", "$window", "$parse", "$attrs", "$timeout", "interact",
						...
						i.snapGrid && (v = r(i.snapGrid)(t), c = {
							...
							onmove: function(e) {
								var l = a.element(e.target),
									...
									c = (parseFloat(l.attr("data-y")) || 0) + (e.dy || 0);
								switch (r(i.axis)(t)) {
									case "x":
										c = 0;
										break;
								...
								"static" === n.getComputedStyle(l[0]).position && l.css("position", "relative"), s(l, "translate(" + d + "px, " + c + "px)").css("z-index", 50).attr("data-x", d).attr("data-y", c), i.onDrag && (r(i.onDrag)(t, o(d, c, v)), t.$apply())
							},
							onend: function(e) {
								var n = a.element(e.target),
									d = n.attr("data-x"),
									c = n.attr("data-y");
								e.target.style.pointerEvents = "auto", i.onDragEnd && (r(i.onDragEnd)(t, o(d, c, v)), t.$apply()), l(function() {
									s(n, "").css("z-index", "auto").removeAttr("data-x").removeAttr("data-y").removeClass("dragging-active")
								})
							}
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlDroppableCtrl", ["$element", "$scope", "$parse", "$attrs", "interact",
				function(e, t, n, r, i) {
					if (i) {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlElementDimensionsCtrl", ["$element", "$scope", "$parse", "$attrs",
				function(e, t, n, a) {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").controller("MwlResizableCtrl", ["$element", "$scope", "$parse", "$attrs", "$timeout", "interact",
				function(e, t, n, r, i, l) {
					...
					if (l) {
						var s, o;
						r.snapGrid && (o = n(r.snapGrid)(t), s = {
							targets: [l.createSnapGrid(o)]
						});
						var c, v = {},
							m = {};
						l(e[0]).resizable({
							...
							onmove: function(e) {
								if (e.rect.width > 0 && e.rect.height > 0) {
									var i = a.element(e.target),
										...
										s = parseFloat(i.data("y") || 0);
									i.css({
										width: e.rect.width + "px",
										height: e.rect.height + "px"
									}), l += e.deltaRect.left, s += e.deltaRect.top, i.css("transform", "translate(" + l + "px," + s + "px)"), i.data("x", l), i.data("y", s), (0 !== e.deltaRect.left || 0 !== e.deltaRect.top) && (c = "start"), r.onResize && (n(r.onResize)(t, d(c, i, o)), t.$apply())
								}
							},
							onend: function(e) {
								var l = a.element(e.target),
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").filter("calendarDate", ["calendarHelper", "calendarConfig",
				function(e, t) {
					function n(n, a, r) {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").filter("calendarTrustAsHtml", ["$sce",
				function(e) {
					return function(t) {
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").factory("calendarHelper", ["$q", "$templateRequest", "dateFilter", "moment", "calendarConfig",
				function(e, t, n, a, r) {
					function i(e, t) {
						if ("angular" === r.dateFormatter) return n(a(e).toDate(), t);
						if ("moment" === r.dateFormatter) return a(e).format(t);
						throw new Error("Unknown date formatter: " + r.dateFormatter)
					}
					...
					function m() {
						for (var e = [], t = 0; 7 > t;) e.push(i(a().weekday(t++), r.dateFormats.weekDay));
						return e
					}

					function u(e, t, n) {
						for (var l = [], d = c(t, "year", e), s = a(t).startOf("year"), m = 0; 12 > m;) {
							var u = s.clone(),
								f = u.clone().endOf("month"),
								p = o(d, u, f),
								w = {
									label: i(u, r.dateFormats.month),
							...
							n({
								calendarCell: w
							}), l.push(w), s.add(1, "month"), m++
						}
						return l
					}

					function f(e, t, n) {
						var i, l = a(t).startOf("month"),
							d = l.clone().startOf("week"),
							s = a(t).endOf("month").endOf("week");
						i = r.displayAllMonthEvents ? o(e, d, s) : o(e, l, l.clone().endOf("month"));
						for (var c = [], m = a().startOf("day"); d.isBefore(s);) {
							var u = d.month() === a(t).month(),
								f = [];
							(u || r.displayAllMonthEvents) && (f = o(i, d, d.clone().endOf("day")));
							var p = {
								label: d.date(),
								date: d.clone(),
								inMonth: u,
							...
							n({
								calendarCell: p
							}), c.push(p), d.add(1, "day")
						}
						return c
					}

					function p(e, t) {
						for (var n = a(t).startOf("week"), l = a(t).endOf("week"), s = n.clone(), c = [], v = a().startOf("day"); c.length < 7;) c.push({
							weekDayLabel: i(s, r.dateFormats.weekDay),
							date: s.clone(),
							dayLabel: i(s, r.dateFormats.day),
							isPast: s.isBefore(v),
							isToday: s.isSame(v),
							isFuture: s.isAfter(v),
							isWeekend: [0, 6].indexOf(s.day()) > -1
						}), s.add(1, "day");
						var m = o(e, n, l).map(function(e) {
							var t, r = a(n).startOf("day"),
								i = a(l).startOf("day"),
								s = d({
								...
								o = s.start,
								c = s.end;
							return t = o.isBefore(r) || o.isSame(r) ? 0 : o.diff(r, "days"), c.isAfter(i) && (c = i), o.isBefore(r) && (o = r), e.daySpan = a(c).diff(o, "days") + 1, e.dayOffset = t, e
						});
						return {
							days: c,
							events: m
					...
					function w(e, t, n, r, i) {
						var l = a(n || "00:00", "HH:mm").hours(),
							...
							f = c / 60,
							p = [],
							w = o(e, a(t).startOf("day").toDate(), a(t).endOf("day").toDate());
					...
					function h(e, t, n, r, i) {
						...
						return l.days.forEach(function(e) {
							var t = l.events.filter(function(t) {
					...
					function g() {
						var n = Object.keys(r.templates).map(function(e) {
							var n = r.templates[e];
							return t(n)
						});
						return e.all(n)
		...
		function(e, t, n) {
			"use strict";
			var a = n(1);
			a.module("mwl.calendar").factory("calendarTitle", ["moment", "calendarConfig", "calendarHelper",
				function(e, t, n) {
					function a(e) {
		...
		function(e, t, n) {
			...
			a.keys = function() {
				return Object.keys(i)
			}, a.resolve = r, e.exports = a, a.id = 37
		},
		function(e, n) {
			e.exports = t
		},
