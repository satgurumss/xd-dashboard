(function() {
  ...
  angular.module('app')
    .controller('TrainingDashCtrl', ['$scope', '$http', '$location', 'gaugesService', 'CONST', '$uibModal', "loggedInUser", TrainingDashCtrl])
    .controller('addEventModalCtrl', ['$scope', '$uibModalInstance', 'startDate', addEventModalCtrl])

  function TrainingDashCtrl($scope, $http, $location, gaugesService, CONST, $uibModal, loggedInUser) {
    ...
    $scope.availableTrainings = [{
      ...
      description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, aspernatur, eum fugit officiis numquam iste aut illo quos pariatur Eligendi, veniam, accusamus.",
      isApplied: true
    }, {
    ...
    $scope.init = function() {
      loggedInUser.isLoggedIn("/my-training");
